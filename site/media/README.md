...
- `mark.svg` in the parent directory is an exact copy of approved `assets/brand/llumi-dark.svg`. Do not redesign it.
- `llumi-macos-usage.webp`: real, unpainted capture of the running Llumi 1.1.1 macOS review build on 23 September 2026. Captured through the app window at 850 × 644; converted losslessly to WebP with metadata removed. Allowance and reset values describe that capture only. This is review-build media, not final release acceptance evidence.
- `llumi-macos-usage-small.webp`: 680 px responsive derivative, WebP quality 88. Same content.
