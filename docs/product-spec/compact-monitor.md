...
Hover expands a small surface containing provider identity, primary percentage, slim progress, primary reset and status when needed. Other usage windows stay in Usage. Click opens/focuses the single existing main window. No duplicate main windows or monitors.
